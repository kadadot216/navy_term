...
void	set_ship2(board_cell_t *cell, char *start, char *end)
{
	cell = set_ship(cell,2, L2);
}

void	set_ship3(board_cell_t *cell, char *start, char *end)
{
	cell =  set_ship(cell,3, L3);
}

void	set_ship4(board_cell_t *cell, char *start, char *end)
{
	cell =  set_ship(cell,4, L4);
}

void	set_ship5(board_cell_t *cell, char *start, char *end)
{
	cell = set_ship(cell,4, L4);
}
